...
\label{sec:ordering}
\mm{rename to background. we also need to include some related work on TO (see epto paper) and on practical evaluation (e.g.: the papers pointed above plus splay}
