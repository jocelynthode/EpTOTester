...
\mm{merge part about event with background section. The part about the conventions/settings used in the experiments should be moved to the evaluation.}
