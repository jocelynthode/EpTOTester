...
class JGroupsChurn(Churn):
    ...
    def __init__(self, hosts_filename=None, service_name='', repository='', delay=0,
                 synthetic=None, file_path='', kill_coordinator_round=None):
        super().__init__(hosts_filename, service_name, repository, delay, synthetic)
    ...
    def suspend_processes(self, to_suspend_nb):
        ...
        for i in range(to_suspend_nb):
            ...
            self.logger.debug("Variables: {} {}".format(self.periods, self.kill_coordinator_round))
                    ...
                    if self.coordinator in containers:
                        ...
                        while count < 3:
                            try:
                                ...
                                self.logger.info(
                                    'Coordinator {:s} on host {:s} was suspended'.format(self.coordinator, host))
