...
class DisseminationTest {
    ...
    fun testDissemination() {
        ...
        Assert.assertTrue(app.peer.orderingComponent.received.size == 11)
        Assert.assertTrue(app1.peer.orderingComponent.received.size == 11)
        Assert.assertTrue(app2.peer.orderingComponent.received.size == 11)
    }
}
