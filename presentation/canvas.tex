...
\ifdefined\ishandout
  \documentclass[handout, usenames, svgnames]{beamer}
\else
...
\institute[Universities of Fribourg and Neuchâtel and Minho]{
	\tiny{\inst{1}Department of Informatics, Université de Fribourg, Switzerland\\
	\hspace*{3pt}\href{mailto:jocelyn.thode@unifr.ch}{jocelyn.thode@unifr.ch}
	\and
	\inst{2}Institute of Computer Science, Université de Neuchâtel, Switzerland\\
